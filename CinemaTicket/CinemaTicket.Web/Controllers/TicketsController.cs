...
namespace CinemaTicket.Web.Controllers
{
    public class TicketsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Create([Bind("Id,TicketName,TicketImage,TicketDesc,TicketPrice,TicketTime,TicketGenre")] Ticket ticket)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Edit(Guid id, [Bind("Id,TicketName,TicketImage,TicketDesc,TicketPrice,TicketTime,TicketGenre")] Ticket ticket)
        {
            if (id != ticket.Id)
            {
                return NotFound();
